export default {
  ...
  setting_main_succeeded: "%(name)s set as main.",
  setting_main_failed: "Setting main character failed. :(",

  update_succeeded: "Character updated.",
  update_failed: "Updating character failed. :(",

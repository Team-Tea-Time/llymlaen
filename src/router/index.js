  ...
  routes: [
    {
      ...
      component: Root,
      children: [
        { path: 'user/characters', component: UserCharacters, beforeEnter: Guards.authenticated },
        { path: 'user/confirm/:code', component: UserConfirm, beforeEnter: Guards.authenticated },
        { path: 'user/register', component: UserRegister, beforeEnter: Guards.guest },
        { path: 'user/login', component: UserLogin, beforeEnter: Guards.guest },
        {
          path: 'admin',
          component: Admin,
